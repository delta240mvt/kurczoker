...
export function BrandWorld({arena,sim,quality}) {
 ...
 return <>
  ...
  {arena.theme==='mill'?<Mill x={25} y={26} sim={sim}/>:!cave&&<Castle position={[arena.width*.78,2.5,-6]} scale={arena.theme==='fortress'?2.8:1.6}/>}
