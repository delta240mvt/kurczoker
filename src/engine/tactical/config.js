...
export const WEAPONS={
 ...
 shotgun:{name:'Dubeltówka',kind:'cone',damage:40,range:5,spreadDeg:12,pellets:5},
 kick:{name:'Kopniak',kind:'contact',damage:10,range:1.2,impulse:6},
 mine:{name:'Mina-jajo',kind:'mine',damage:35,radius:2,armSeconds:.8,triggerRadius:.8},
 cluster:{name:'Jajo kasetowe',kind:'cluster',damage:0,radius:0,fuse:2.5,restitution:.45,fragments:5,fragmentDamage:12},
};
